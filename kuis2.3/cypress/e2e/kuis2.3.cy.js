describe('empty spec', () => {
  it('passes', () => {
    ...
    cy.get('#AspekForm > .modal-body > .form-group > :nth-child(2) > .input-group > .form-control').type("")
    cy.get(':nth-child(5) > .input-group > .form-control').type("")
    cy.get(':nth-child(8) > .input-group > .form-control').type("")
    cy.get(':nth-child(14) > .input-group > .form-control').type("")
    cy.get(':nth-child(17) > .input-group > .form-control').type("")
    cy.get(':nth-child(20) > .input-group > .form-control').type("")
